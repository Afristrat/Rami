...
DROP POLICY IF EXISTS "ai_prompts_config_select_super_admin" ON ai_prompts_config;
CREATE POLICY "ai_prompts_config_select_super_admin"
  ON ai_prompts_config FOR SELECT
  USING (is_super_admin());

-- Insertion : super_admin uniquement
DROP POLICY IF EXISTS "ai_prompts_config_insert_super_admin" ON ai_prompts_config;
CREATE POLICY "ai_prompts_config_insert_super_admin"
  ON ai_prompts_config FOR INSERT
  WITH CHECK (is_super_admin());

-- Mise à jour : super_admin uniquement
DROP POLICY IF EXISTS "ai_prompts_config_update_super_admin" ON ai_prompts_config;
...
DROP POLICY IF EXISTS "ai_prompts_config_delete_super_admin" ON ai_prompts_config;
